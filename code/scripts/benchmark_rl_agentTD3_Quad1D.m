function completed = benchmark_rl_agentTD3_Quad1D()
% benchmark_neuralNetwork_rl_agentTD3_Quad1D - Example for set-based
...
%
% Syntax:
%    res = benchmark_neuralNetwork_rl_agentTD3_Quad1D()
%
% Inputs:
%    -
%
...
evaluateAgentsStatistically(agents,env,0:0.05:0.5,'inf');
